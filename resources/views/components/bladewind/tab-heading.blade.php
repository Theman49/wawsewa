...
<li class="cursor-pointer atab atab-{{ $name }}"
    ...
    <span class="inline-block py-1 px-3 text-md font-medium text-center border-b-2 @if($disabled !== 'false') text-gray-300 hover:!text-gray-300 cursor-not-allowed @else
