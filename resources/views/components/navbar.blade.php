    ...
    <div class="container flex justify-between ">
        <div class="flex gap-2 items-center">
            ...
            <div class="flex justify-between items-center">
                <p class="text-xs font-normal">Gunungpati, Semarang</p>
                <i class="material-icons-outlined text-md">
                    expand_more
                </i>
            </div>
        ...
        <div class="flex items-center gap-6 text-xs font-normal">
            <li><a href="#">Tentang Waw Sewa</a></li>
            <li><a href="#">Sewakan Barang</a></li>
            <li><a href="#">Syarat Dan Ketentuan Penggunaan</a></li>
